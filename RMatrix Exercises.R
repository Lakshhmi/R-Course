...
# from the vectors.You'll need to figure out which of these binding functions is
# # the correct choice.
...
# Ex 5: Using indexing notation, 
# grab a sub-section of mat2 from the previous exercise that looks like this:
...
matrix(runif(20,min = 1,max = 20),nrow = 4,ncol = 5)
